...
public class BorrowerTable extends javax.swing.JFrame {
    ...
    private void ShowData()
    {
        try {
            ...
            bookTable.addColumn("Kode Peminjaman");
            bookTable.addColumn("Kode Buku");
            bookTable.addColumn("NIM Peminjaman");
            bookTable.addColumn("Jumlah Peminjaman");
            bookTable.addColumn("tanggal Peminjaman");
            ...
            theBorrowerTable.setModel(bookTable);
